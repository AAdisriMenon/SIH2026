...
const TRANSLATIONS = {
  ...
  bn: {
      ...
      "appSubtitle": "প্রান্তিক উদ্যোক্তাদের জন্য সুবিধাজনক ঋণ",
      "govIndia": "ভারত সরকার • সামাজিক ন্যায় ও ক্ষমতায়ন মন্ত্রক",
      "sihBadge": "| স্মার্ট ইন্ডিয়া হ্যাকাথন ২০২৬ (PS #26092)",
      "zeroHallucination": "জিরো-হ্যালুসিনেশন যাচাইকৃত",
      "heroTitle": "প্রান্তিক উদ্যোক্তাদের জন্য এআই-চালিত সরকারি প্রকল্পের সন্ধান",
      "heroDesc": "এসসি, এসটি, ওবিসি, সংখ্যালঘু, মহিলা এবং দিব্যাঙ্গজন উদ্যোক্তাদের জন্য সুনির্দিষ্ট ও নির্ভরযোগ্য সরকারি প্রকল্প ম্যাচিং।",
      "formTitle": "উদ্যোক্তার প্রোফাইল লিখুন",
      "btnFindSchemes": "উপযুক্ত প্রকল্প খুঁজুন",
      "btnMatching": "প্রকল্প মূল্যায়ন করা হচ্ছে...",
      "category": "সামাজিক বিভাগ *",
      "gender": "লিঙ্গ *",
      "age": "বয়স (বছর) *",
      "annualIncome": "বার্ষিক পারিবারিক আয় (₹) *",
      "isPwd": "প্রতিবন্ধী ব্যক্তি (দিব্যাঙ্গজন)?",
      "pwdPercent": "প্রতিবন্ধিতার শতাংশ (%)",
      "businessSector": "ব্যবসার ক্ষেত্র *",
      "state": "রাজ্য / কেন্দ্রশাসিত অঞ্চল *",
      "businessIdea": "আপনার ব্যবসার পরিকল্পনা বর্ণনা করুন *",
      "projectCost": "প্রকল্প ব্যয় (₹) *",
      "education": "শিক্ষাগত যোগ্যতা *",
      "chatAssistantBtn": "এআই প্রকল্প সহকারী",
      "tabAdmin": "অ্যাডমিন কনসোল",
      "presetLabel": "দ্রুত ডেমো প্রোফাইল:",
      "personaRekhaBtn": "🧵 রেখা (ওবিসি মহিলা • সেলাই)",
      "personaSureshBtn": "🔧 সুরেশ (এসসি পুরুষ • ওয়ার্কশপ)",
      "personaImranBtn": "🔨 ইমরান (সংখ্যালঘু • পিতল কারিগর)",
      "personaAnitaBtn": "♿ অনিতা (দিব্যাঙ্গজন ৫০% • হস্তশিল্প)",
      "tabEligibleText": "যোগ্য প্রকল্প",
      "tabBorderlineText": "প্রান্তিক / সংশোধনযোগ্য",
      "tabIneligibleText": "অযোগ্য প্রকল্প",
      "officialPortal": "অফিসিয়াল পোর্টালে যান",
      "printPdf": "প্রিন্ট / পিডিএফ",
      "shareWhatsApp": "হোয়াটসঅ্যাপে শেয়ার",
      "verifiedPrefix": "যাচাইকরণ তারিখ:",
      "perAnnum": "বার্ষিক",
      "perMonth": "/ মাস",
      "capitalSubsidy": "মূলধন ভর্তুকি",
      "softCredit": "সুবিধাজনক ঋণ",
      "asApproved": "অনুমোদন সাপেক্ষে",
      "concessional": "সুবিধাজনক হার",
      "statusEligible": "যোগ্য",
      "statusBorderline": "প্রান্তিক বিবেচনা",
      "statusIneligible": "অযোগ্য",
      "whyMatchedAudit": "কেন উপযুক্ত (নিয়ম নিরীক্ষা ট্রেইল)",
      "whyIneligibleAudit": "অযোগ্যতার কারণ নিরীক্ষা",
      "relevanceSuffix": "প্রাসঙ্গিকতা",
      "voiceInput": "ভয়েস ইনপুট",
      "voiceListeningShort": "শুনছি...",
      "receiptEntrepreneur": "উদ্যোক্তা",
      "navBusinessMatcher": "ব্যবসা ও ঋণ ম্যাচিং",
      "navGeneralBenefits": "সমস্ত সরকারি প্রকল্প (৪১+)",
      "generalBenefitsTitle": "সার্বিক সরকারি প্রকল্প ও সামাজিক কল্যাণ ভাণ্ডার",
      "generalBenefitsSubtitle": "কৃষি, স্বাস্থ্য, আবাসন, পেনশন এবং জ্বালানি সংক্রান্ত যাচাইকৃত জাতীয় ও রাজ্য উদ্যোগ।"
  },

  te: {
      "name": "తెలుగు (Telugu)",
      "appTitle": "MoSJE పథకాల సరిపోలిక వేదిక",
      "appSubtitle": "బలహీన వర్గాల వ్యాపారవేత్తలకు రాయితీ రుణాలు",
      "govIndia": "భారత ప్రభుత్వం • సామాజిక న్యాయం & సాధికారత మంత్రిత్వ శాఖ",
      "sihBadge": "| స్మార్ట్ ఇండియా హ్యాకథాన్ 2026 (PS #26092)",
      "zeroHallucination": "జీరో-భ్రమ ధృవీకరించబడింది",
      "heroTitle": "బలహీన వర్గాల వ్యాపారవేత్తల కోసం ఏఐ ఆధారిత పథకాల గుర్తింపు",
      "heroDesc": "ఎస్సీ, ఎస్టీ, బీసీ, మైనారిటీ, మహిళలు మరియు దివ్యాంగుల కోసం పారదర్శక మరియు నియమానుసార పథకాల గుర్తింపు.",
      "formTitle": "వ్యాపారవేత్త వివరాలు నమోదు చేయండి",
      "btnFindSchemes": "అర్హతగల పథకాలను కనుగొనండి",
      "btnMatching": "పథకాలను సరిచూస్తున్నాము...",
      "category": "సామాజిక వర్గం *",
      "gender": "లింగం *",
      "age": "వయస్సు (సంవత్సరాలు) *",
      "annualIncome": "వార్షిక ఆదాయం (₹) *",
      "isPwd": "దివ్యాంగులా (PwD)?",
      "pwdPercent": "వైకల్యం శాతం (%)",
      ...
      "chatAssistantBtn": "ఏఐ పథకాల సహాయకుడు",
      "tabAdmin": "అడ్మిన్ కన్సోల్",
      "presetLabel": "డెమో ప్రొఫైల్స్:",
      "personaRekhaBtn": "🧵 రేఖ (ఓబీసీ మహిళ • టైలరింగ్)",
      "personaSureshBtn": "🔧 సురేష్ (ఎస్సీ పురుషుడు • వర్క్‌షాప్)",
      "personaImranBtn": "🔨 ఇమ్రాన్ (మైనారిటీ • ఇత్తడి కళాకారుడు)",
      "personaAnitaBtn": "♿ అనిత (దివ్యాంగురాలు 50% • చేతిపనులు)",
      "tabEligibleText": "అర్హత గల పథకాలు",
      "tabBorderlineText": "పరిశీలనలో ఉన్నవి",
      "tabIneligibleText": "అర్హత లేనివి",
      "officialPortal": "అధికారిక పోర్టల్ సందర్శించండి",
      "printPdf": "ప్రింట్ / PDF",
      "shareWhatsApp": "వాట్సాప్‌లో భాగస్వామ్యం",
      "verifiedPrefix": "ధృవీకరణ తేదీ:",
      "perAnnum": "సంవత్సరానికి",
      "perMonth": "/ నెలకు",
      "capitalSubsidy": "మూలధన రాయితీ",
      "softCredit": "రాయితీ రుణం",
      "asApproved": "ఆమోదించబడిన మేరకు",
      "concessional": "రాయితీ వడ్డీ",
      "statusEligible": "అర్హత ఉంది",
      "statusBorderline": "సరిహద్దు స్థితి",
      "statusIneligible": "అర్హత లేదు",
      "whyMatchedAudit": "ఎందుకు సరిపోయింది (నియమాల వివరాలు)",
      "whyIneligibleAudit": "అనర్హతకు గల కారణాలు",
      "relevanceSuffix": "సరిపోలిక",
      "voiceInput": "వాయిస్ ఇన్‌పుట్",
      "voiceListeningShort": "వింటున్నాను...",
      "receiptEntrepreneur": "వ్యాపారవేత్త",
      "navBusinessMatcher": "వ్యాపార రుణాల గుర్తింపు",
      "navGeneralBenefits": "అన్ని ప్రభుత్వ పథకాలు (41+)",
      "generalBenefitsTitle": "సమగ్ర ప్రభుత్వ పథకాలు & సామాజిక సంక్షేమ నిధి",
      "generalBenefitsSubtitle": "వ్యవసాయం, ఆరోగ్యం, గృహనిర్మాణం, పెన్షన్లు మరియు ఇంధన రంగాలలో ధృవీకరించబడిన కేంద్ర & రాష్ట్ర పథకాలు."
  },

  gu: {
      "name": "ગુજરાતી (Gujarati)",
      "appTitle": "MoSJE યોજના મેચિંગ પ્લેટફોર્મ",
      "appSubtitle": "વંચિત ઉદ્યોગસાહસિકો માટે રાહત દરે લોન સહાય",
      "govIndia": "ભારત સરકાર • સામાજિક ન્યાય અને અધિકારીતા મંત્રાલય",
      "sihBadge": "| સ્માર્ટ ઇન્ડિયા હેકાથોન 2026 (PS #26092)",
      "zeroHallucination": "ઝીરો-ભ્રમણા પ્રમાણિત",
      "heroTitle": "વંચિત ઉદ્યોગસાહસિકો માટે AI-આધારિત સરકારી યોજના શોધ",
      "heroDesc": "SC, ST, OBC, લઘુમતી, મહિલા અને દિવ્યાંગ ઉદ્યોગસાહસિકો માટે પારદર્શક યોજના મેચિંગ.",
      "formTitle": "ઉદ્યોગસાહસિક પ્રોફાઇલ દાખલ કરો",
      "btnFindSchemes": "પાત્ર યોજનાઓ શોધો",
      "btnMatching": "યોજનાઓનું મૂલ્યાંકન ચાલુ છે...",
      ...
      "businessSector": "વ્યવસાય ક્ષેત્ર *",
      "state": "રાજ્ય / કેન્દ્રશાસિત પ્રદેશ *",
      "businessIdea": "તમારા વ્યવસાય વિચારનું વર્ણન કરો *",
      "projectCost": "પ્રોજેક્ટ ખર્ચ (₹) *",
      "education": "શિક્ષણ *",
      "chatAssistantBtn": "AI યોજના સહાયક",
      "tabAdmin": "એડમિન કન્સોલ",
      "presetLabel": "ઝડપી ડેમો પ્રોફાઇલ્સ:",
      "personaRekhaBtn": "🧵 રેખા (OBC મહિલા • સિલાઈ)",
      ...
      "verifiedPrefix": "ચકાસણી તારીખ:",
      "perAnnum": "વાર્ષિક",
      "perMonth": "/ મહિને",
      "capitalSubsidy": "મૂડી સબસિડી",
      "softCredit": "રાહત લોન",
      "asApproved": "મંજૂરી મુજબ",
      "concessional": "રાહત દર",
      "statusEligible": "પાત્ર",
      "statusBorderline": "સીમારેખા",
      "statusIneligible": "અપાત્ર",
      "whyMatchedAudit": "શા માટે યોગ્ય (ઓડિટ ટ્રેલ)",
      "whyIneligibleAudit": "અપાત્રતાનું ઓડિટ",
      "relevanceSuffix": "સુસંગતતા",
      "voiceInput": "વોઇસ ઇનપુટ",
      "voiceListeningShort": "સાંભળી રહ્યું છે...",
      "receiptEntrepreneur": "ઉદ્યોગસાહસિક",
      "navBusinessMatcher": "વ્યવસાય લોન મેચિંગ",
      "navGeneralBenefits": "તમામ સરકારી યોજનાઓ (41+)",
      "generalBenefitsTitle": "સમગ્ર સરકારી યોજનાઓ અને સામાજિક કલ્યાણ ભંડાર",
      "generalBenefitsSubtitle": "કૃષિ, આરોગ્ય, આવાસ, પેન્શન અને ઉર્જા સંબંધિત ચકાસાયેલ કેન્દ્રીય અને રાજ્ય પહેલ."
  },
  ...
  kn: {
      ...
      "zeroHallucination": "ಶೂನ್ಯ-ಭ್ರಮೆ ಪರಿಶೀಲಿತ",
      "heroTitle": "ಹಿಂದುಳಿದ ಉದ್ಯಮಿಗಳಿಗೆ AI ಆಧಾರಿತ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳ ಶೋಧ",
      "heroDesc": "SC, ST, OBC, ಅಲ್ಪಸಂಖ್ಯಾತ, ಮಹಿಳೆಯರು ಮತ್ತು ದಿವ್ಯಾಂಗ ಉದ್ಯಮಿಗಳಿಗಾಗಿ ಪಾರದರ್ಶಕ ಯೋಜನೆಗಳ ಪರಿಶೀಲನೆ.",
      "formTitle": "ಉದ್ಯಮಿ ವಿವರ ನಮೂದಿಸಿ",
      ...
      "isPwd": "ವಿಕಲಚೇತನರೇ (ದಿವ್ಯಾಂಗ)?",
      "pwdPercent": "ವಿಕಲಚೇತನತೆ ಶೇಕಡಾವಾರು (%)",
      ...
      "tabAdmin": "ನಿರ್ವಾಹಕ ಕನ್ಸೋಲ್",
      "presetLabel": "ಡೆಮೊ ಪ್ರೊಫೈಲ್ಸ್:",
      "personaRekhaBtn": "🧵 ರೇಖಾ (OBC ಮಹಿಳೆ • ಟೈಲರಿಂಗ್)",
      "personaSureshBtn": "🔧 ಸುರೇಶ್ (SC ಪುರುಷ • ಕಾರ್ಯಾಗಾರ)",
      "personaImranBtn": "🔨 ಇಮ್ರಾನ್ (ಅಲ್ಪಸಂಖ್ಯಾತ • ಹಿತ್ತಾಳೆ ಕುಶಲಕರ್ಮಿ)",
      "personaAnitaBtn": "♿ ಅನಿತಾ (ದಿವ್ಯಾಂಗ 50% • ಕರಕುಶಲ)",
      "tabEligibleText": "ಅರ್ಹ ಯೋಜನೆಗಳು",
      "tabBorderlineText": "ಗಡಿರೇಖೆಯ ಪರಿಶೀಲನೆ",
      "tabIneligibleText": "ಅನರ್ಹ ಯೋಜನೆಗಳು",
      "officialPortal": "ಅಧಿಕೃತ ಪೋರ್ಟಲ್‌ಗೆ ಭೇಟಿ ನೀಡಿ",
      "printPdf": "ಮುದ್ರಿಸಿ / PDF",
      "shareWhatsApp": "ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ ಹಂಚಿಕೊಳ್ಳಿ",
      "verifiedPrefix": "ಪರಿಶೀಲಿಸಿದ ದಿನಾಂಕ:",
      "perAnnum": "ವಾರ್ಷಿಕವಾಗಿ",
      "perMonth": "/ ತಿಂಗಳಿಗೆ",
      "capitalSubsidy": "ಬಂಡವಾಳ ಸಬ್ಸಿಡಿ",
      "softCredit": "ರಿಯಾಯಿತಿ ಸಾಲ",
      "asApproved": "ಅನುಮೋದನೆಯಂತೆ",
      "concessional": "ರಿಯಾಯಿತಿ ದರ",
      "statusEligible": "ಅರ್ಹ",
      "statusBorderline": "ಗಡಿರೇಖೆ",
      "statusIneligible": "ಅನರ್ಹ",
      "whyMatchedAudit": "ಹೊಂದಾಣಿಕೆಯ ವಿವರಣೆ",
      "whyIneligibleAudit": "ಅನರ್ಹತೆಯ ಕಾರಣಗಳು",
      "relevanceSuffix": "ಹೊಂದಾಣಿಕೆ",
      "voiceInput": "ಧ್ವನಿ ಇನ್‌ಪುಟ್",
      "voiceListeningShort": "ಆಲಿಸುತ್ತಿದೆ...",
      "receiptEntrepreneur": "ಉದ್ಯಮಿ",
      "navBusinessMatcher": "ಉದ್ಯಮ ಸಾಲ ಮ್ಯಾಚಿಂಗ್",
      "navGeneralBenefits": "ಎಲ್ಲಾ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು (41+)",
      "generalBenefitsTitle": "ಸಮಗ್ರ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳು ಮತ್ತು ಸಾಮಾಜಿಕ ಕಲ್ಯಾಣ ನಿಧಿ",
      "generalBenefitsSubtitle": "ಕೃಷಿ, ಆರೋಗ್ಯ, ವಸತಿ, ಪಿಂಚಣಿ ಮತ್ತು ಇಂಧನ ವಲಯದ ಪರಿಶೀಲಿತ ಕೇಂದ್ರ ಮತ್ತು ರಾಜ್ಯ ಯೋಜನೆಗಳು."
  },
...
// Assign fallback options and schemes for all languages to ensure complete coverage
Object.keys(TRANSLATIONS).forEach(function(lang) {
  if (lang !== 'en') {
    if (!TRANSLATIONS[lang].options) TRANSLATIONS[lang].options = TRANSLATIONS.en.options;
    if (!TRANSLATIONS[lang].schemes) TRANSLATIONS[lang].schemes = TRANSLATIONS.en.schemes;
  }
});
